...
Release candidate **0.1.0-alpha.6**, audited **2026-09-17**. Scope: Core v1.35, supplied Errata, and *A Tome of Chaos* v1.01; Foundry V14/The Forge. This records implementation coverage, not a claim that every magic entry is automated.
